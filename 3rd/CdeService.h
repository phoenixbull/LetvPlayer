...
-(bool)syncGetPolicy:(NSString *)url; //sync get Dynamic configuration
-(void)asynGetPolicy:(NSString *)url;//asyn get Dynamic configuration
...
-(NSString *)linkshellDownloadUrl:(NSString *)url;//get download url titan or lepcdn
-(NSString *)getMetaUrl:(NSString *)url;//get play url from cde
